...
<!-- For checkpoint task examples and patterns, see @/workspace/.cursor/get-shit-done/references/checkpoints.md -->
...
See `/workspace/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspace/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspace/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
