...
```bash
node "/workspace/.cursor/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/workspace/.cursor/get-shit-done/bin/gsd-tools.cjs" validate health
```
