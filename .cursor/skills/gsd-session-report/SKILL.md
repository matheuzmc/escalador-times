...
<execution_context>
@/workspace/.cursor/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/workspace/.cursor/get-shit-done/workflows/session-report.md end-to-end.
</process>
