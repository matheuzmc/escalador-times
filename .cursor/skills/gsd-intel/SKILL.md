...
Intel system is disabled. To activate:
  ...
  node /workspace/.cursor/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /workspace/.cursor/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /workspace/.cursor/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /workspace/.cursor/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /workspace/.cursor/get-shit-done/bin/gsd-tools.cjs
