...
Intel system is disabled. To activate:
  ...
  node /workspace/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /workspace/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /workspace/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /workspace/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /workspace/.codex/get-shit-done/bin/gsd-tools.cjs
