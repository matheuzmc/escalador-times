...
<execution_context>
@/workspace/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @/workspace/.codex/get-shit-done/workflows/add-tests.md end-to-end.
