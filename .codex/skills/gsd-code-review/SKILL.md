...
<execution_context>
@/workspace/.codex/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @/workspace/.codex/get-shit-done/workflows/code-review.md end-to-end.
