...
<execution_context>
@/workspace/.codex/get-shit-done/workflows/resume-project.md
</execution_context>

<process>
**Follow the resume-project workflow** from `@/workspace/.codex/get-shit-done/workflows/resume-project.md`.
