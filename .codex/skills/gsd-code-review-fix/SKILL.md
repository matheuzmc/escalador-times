...
<execution_context>
@/workspace/.codex/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/workspace/.codex/get-shit-done/workflows/code-review-fix.md end-to-end.
