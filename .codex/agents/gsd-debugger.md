...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspace/.codex/get-shit-done
                  → writes to /workspace/.codex/get-shit-done/hooks/
...
@/workspace/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspace/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/workspace/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/workspace/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/workspace/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
