...
Intel system is disabled. To activate:
  ...
  node /workspace/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /workspace/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /workspace/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /workspace/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
