...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspace/.opencode
                  → checks /workspace/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspace/.opencode/get-shit-done
                  → writes to /workspace/.opencode/get-shit-done/hooks/
...
@/workspace/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspace/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/workspace/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/workspace/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/workspace/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
