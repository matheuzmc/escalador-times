...
Use template from `/workspace/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/workspace/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/workspace/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
